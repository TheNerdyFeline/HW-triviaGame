...
var q16 = new NewQuestion("In the movie Finding Nemo, which country has Nemo been taken to?", "Australia","England", "Africa", "Pacific Coast", "./assets/images/nemo-autralia.jpg");
...
var q23 = new NewQuestion("After being on earth, where did Hercules first meet his father Zeus?", "Temple of Zeus","Atlantis City", "Olympus Coliseum", "Prometheus Academy", "./assets/images/temple-of-zeus");
var q24 = new NewQuestion("Which is the only Disney animated film with a main character that doesn’t speak?", "Dumbo", "Tanlged", "Fantasia", "101 Dalmations", "Lady and the Tramp","./assets/images/dumbo.jpg" );
